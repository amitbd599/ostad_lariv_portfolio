...
const GetAllPortfolio = () => {
  let { allPortfolioData, allPortfolioRequest, deletePortfolioRequest } =
    PortfolioStore();
  ...
  let deleteExperience = async (id) => {
    let res = await DeleteAlert(deletePortfolioRequest, id);
    if (res) {
      allPortfolioRequest();
    }
  };
        ...
        <div className='container mx-auto '>
          <div>
            <div className='border border-gray-200 px-[30px] py-[40px] rounded-[20px] '>
              <div>
                <h2 className='text-[30px] font-bold'>Get All Portfolio</h2>
              </div>
                        ...
                        <tr className='hover:bg-gray-50' key={index}>
                          ...
                          <td className='px-6 py-4'>
                            <div className='flex justify-end gap-4'>
                              ...
                              <Link
                                to={`/update-single-portfolio/${item?._id}`}
                              >
